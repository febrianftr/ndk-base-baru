$(document).ready(function () {
  ...
  $("#report-excel").validate({
    ...
    submitHandler: function () {
      ...
      let url = `http://${location.hostname}:20007/api/export-excel?from_updated_time=${from_workload}&to_updated_time=${to_workload}&mods_in_study=${join_mods_in_study}&priority_doctor=${join_priority_doctor}&radiographer_name=${join_radiographer}`;
      $.ajax({
        type: "GET",
        url: url,
        beforeSend: function () {
