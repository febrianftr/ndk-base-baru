...
$waiting6hourContrast = mysqli_query(
	$conn_pacsio,
	"SELECT 
	$select_patient, 
	$select_study, 
...
<div class="fill">
	<div class="table-responsive-sm">
		<h5 class="text-center">The patient has not been read for more than 6 hour <p class="font-weight-bold"> (Contrast)</p>
		</h5>
	</div>
	<br>
	<h4>
		<strong>
			<table class="table-dicom" id="example" style="margin-top: 3px;" cellpadding="8" cellspacing="0">
				<thead class="thead1">
					...
					<?php
					if (mysqli_num_rows($waiting6hourContrast) > 0) {
						while ($row1 = mysqli_fetch_assoc($waiting6hourContrast)) {
