...
<div class="fill">
    <h5 class="text-center font-weight-bold">Move <?= $is_study_series ?></h5>
    ...
    <br>
    <table class="table-dicom" id="example-move-image" border="0" cellpadding="8" cellspacing="0">
        <thead>
            <tr bgcolor=#CCCCCC>
                <th>No</th>
                <th>Action</th>
...
<script>
    $(document).ready(function() {
        let a = $('#modal-move-image #example-move-image').DataTable({
            "ajax": {
                "url": "getMoveImage.php?pk_parent=<?= $pk_parent; ?>&pk_child=<?= $pk_child; ?>&study_iuid_parent=<?= $study_iuid_parent; ?>&is_study_series=<?= $is_study_series; ?>",
                "dataSrc": ""
            },
            "columns": [{
                    // "class": 'dt-control',
