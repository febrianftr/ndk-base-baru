...
@$radiographer_name2 = addslashes($_POST['radiographer_name']);
...
if (mysqli_affected_rows($conn_pacs) > 0) {
	echo "<script>alert('Succsess to Worklist');</script>
    	<script>document.location.href='exam2.php';</script>";
} else {
	echo "<script>alert('Failed to process');</script>
    	<script>document.location.href='exam2.php';</script>";
}
