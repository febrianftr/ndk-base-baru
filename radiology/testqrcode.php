...
<script>
	...
	document.location.href= 'testqrcode2.php?uid=$uid';
</script>
";
    } else {
        echo "
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-md-offset-3 table-box11">
                                        ...
                                        <form action="" method="POST">
                                            <div style="width: 100%;">
                                                <a href="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>:8089/intiwid/radiology/pdf/testpdf4.php?uid=<?= $uid; ?>" target="_blank" name="pdf">
                                                    <div class="btn" style="width: 100%; background-color: #d75c67; color: #fff;"><b>PDF</b></div>
                                                </a>
                                            </div>
                                            <div style="float: right;">
                                                <label>
                                                    <input type="checkbox" name="approvedsign" value="SIGN APPROVED">&nbsp;Approve
                                                </label>
                                            </div>
                                            <br>
                                            <br>
                                            ...
                                            <div class="btn-bar-1" style="float: right;">
                                                <button class="btn btn-success" name="approvesign"><i class="fas fa-check" style="font-size: 15px;"></i></button>
                                        ...
                                        <div class="sign-container">
                                            ...
                                            ?>
                                            <?php } else { ?>
                                                <img src="/phpqrcode/ttddokter/<?php echo $uid . '.' . 'png'; ?>" class="sign-preview" />
                                            <?php } ?>
                                        </div>
                                    </div>
