...
$kondisi = "WHERE (xray_workload.status = 'waiting' AND xray_order.dokradid = '$dokradid' AND xray_order.priority = 'cito' AND study.study_datetime >= '2024-02-29')
OR (xray_workload.status = 'waiting' AND xray_order.dokradid IS NULL AND xray_order.priority = 'cito' AND study.study_datetime >= '2024-02-29')
