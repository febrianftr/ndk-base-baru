...
$pdf->image('../../pdf/cop_bagan.jpg', 2, 0, 200, 40);
$pdf->MultiCell(0, 5, ' 
...
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(57, 5, $name1 . ' ' . $lastname, 0, 0, 'L');
// ------------------
$pdf->Cell(45, 5, 'Prosedur', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(59, 5, $prosedur, 0, 1, 'L');
// ------------------
$pdf->Cell(35, 5, 'MRN', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(57, 5, $mrn, 0, 0, 'L');
// ------------------
$pdf->Cell(45, 5, 'Dokter Pengirim', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(59, 5, $named1 . ' ' . $lastnamed1, 0, 1, 'L');
// -----------------
$pdf->Cell(35, 5, 'Jenis Kelamin', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(57, 5, $sex, 0, 0, 'L');
// -----------------
$pdf->Cell(45, 5, 'Klinik/Diagnosa', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(59, 5, $spc_needs, 0, 1, 'L');
// -----------------
$pdf->Cell(35, 5, 'Departemen', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(57, 5, $name_dep, 0, 0, 'L');
// -------------------
$pdf->Cell(45, 5, 'Waktu Pemeriksaan', 0, 0, 'L');
$pdf->Cell(3, 5, ':', 0, 0, 'L');
$pdf->Cell(59, 5, $updated_time1, 0, 1, 'L');
//-------------------
$pdf->Cell(35, 5, 'Umur', 'B', 0, 'L');
$pdf->Cell(3, 5, ':', 'B', 0, 'L');
$pdf->Cell(57, 5, $diff->y . 'Y' . ' ' . $diff->m . 'M' . ' ' . $diff->d, 'B', 0, 'L');
// -----------------
$pdf->Cell(45, 5, 'Waktu Baca', 'B', 0, 'L');
$pdf->Cell(3, 5, ':', 'B', 0, 'L');
$pdf->Cell(59, 5, $approve_date1 . ' ' . $approve_time1, 'B', 1, 'L');
...
$fill = str_replace('<div style="text-align: center;">', '<p align="center">', $fill);
$fill = str_replace('<div style="text-align: left;">', '<p align="left">', $fill);
$fill = str_replace('<div style="text-align: right;">', '<p align="right">', $fill);
$fill = str_replace('<div>', '<p align="left">', $fill);
$fill = str_replace('<div style="text-align:center;">', '<p align="center">', $fill);
$fill = str_replace('<div style="text-align:left;">', '<p align="left">', $fill);
$fill = str_replace('<div style="text-align:right;">', '<p align="right">', $fill);
$fill = str_replace("</div>", "</p>", $fill);
$pdf->WriteHTML("<br>");
$pdf->WriteHtml($fill);
$pdf->WriteHTML("<br>");
$pdf->WriteHTML("<br>");
// $pdf->image('../../image/'. $imgtemp , 140, 240, 60, 40);
$pdf->WriteHTML(
    "<b>Salam Sejawat,</b><br>
<b><p align='left' margin-left='50px;'>BTK</p></b><br><br><br><br><br>
" .
...
$mail->addAddress($email, $named . ' ' . $lastnamed);
