									...
									<?php foreach ($data_dokter_radiology as $row) : ?>
										<tr>
											...
											<td>
												...
												<a href="delete_dokter_radiology.php?pk=<?= $row["pk"]; ?> &amp; id_table=<?= $row['id_table']; ?>" onclick="return confirm('Teruskan Menghapus Data?');"><img data-toggle="tooltip" title="Hapus" class="iconbutton" src="../image/delete.png"></a>
											</td>
										</tr>
										<?php $i++; ?>
									<?php endforeach; ?>
