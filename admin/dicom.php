...
$query = "SELECT * 
		  FROM patient
		  INNER JOIN study ON patient.pk=study.pk ORDER BY pat_id";
		...
		<table border="1" cellpadding="8" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="http://192.168.2.91:19898/weasis-pacs-connector/DCM_viewer.jnlp?studyUID=<?php echo $row['uid']; ?>"><i class="far fa-eye"></i></a><a href="http://192.168.2.91:3000/viewer/<?php echo $row['uid']; ?>"><img src="">COBA</a>
					</td>
					<!-- <td>
					<a href="http://192.168.2.91:8080/weasis-pacs-connector/viewer?pat_id=<?php echo $row['pat_id']; ?>"><img class="img-view" src="image/viewer.png"></a>
					</td> -->
				</tr>
				<?php endwhile; ?>
			</tbody>
