...
if (isset($_POST["submit"])) {
    if ($_POST['passwordconfirm'] == "27102108") {
        if (new_ae_worklist($_POST) > 0) {
            ...
            window.location.replace('view_ae_worklist.php');
            } ,1000); 
        </script>";
        } else {
            echo "<script type='text/javascript'>
            ...
            window.setTimeout(function(){ 
            window.location.replace('new_ae_worklist.php');
            } ,1000); 
        </script>";
        }
    } else {
...
?>
    ...
    <body>
        ...
        <div id="container1">
            <div id="content1">
                <div class="body">
                    <h1 style="color: #ee7423"><?= $lang['add_aetitle'] ?> worklist</h1>
                    <div class="container">
                        <div class="row">
                            <a class="ahref" href="view_ae_worklist.php"><i class="fas fa-eye"></i><?= $lang['view_aetitle'] ?></a>
                            <br><br>
                        </div>
                    </div>
